/**
 * English version drama data
 * TODO: Replace with actual overseas drama videos when ready
 * For now, using the same videos as Chinese version as placeholders
 */

export const VIDEO_MAP = {
  5: {
    title: "Captive",
    cover: "https://nocode.meituan.com/photo/search?keyword=fantasy,princess,castle&width=400&height=600",
    episodes: [
      "https://s3plus.meituan.net/mcopilot-pub/nocode-task/chenyanbo/920dykquhr9it317nelyybut1tnjkw/1.mp4",
      "https://s3plus.meituan.net/mcopilot-pub/nocode-task/chenyanbo/wizypnd0co9pg6u0hrsxvfsa0cifwa/2.mp4",
      "https://s3plus.meituan.net/mcopilot-pub/nocode-task/chenyanbo/lue5s2zd8qs2a1qp55fp2oan43f7fm/3.mp4",
      "https://s3plus.meituan.net/mcopilot-pub/nocode-task/chenyanbo/en6ee2q21xo0we5h21rkxu4ih1hy8i/4.mp4",
      "https://s3plus.meituan.net/mcopilot-pub/nocode-task/chenyanbo/mlwdb7nfdkn1fk3vd2dulgm4k22ylp/5.mp4",
      "https://s3plus.meituan.net/mcopilot-pub/nocode-task/chenyanbo/zyarah2fet8w65h7r154af8l1upglg/6.mp4",
      "https://s3plus.meituan.net/mcopilot-pub/nocode-task/chenyanbo/nlbd69gq4d6xedo3exqtlwrds0u1ys/7.mp4",
      "https://s3plus.meituan.net/mcopilot-pub/nocode-task/chenyanbo/mmlgjhqtb8d67tr4vtmtos20wop46h/8.mp4",
      "https://s3plus.meituan.net/mcopilot-pub/nocode-task/chenyanbo/a75eqwfv1ihii4u0wis828pyxs97pz/9.mp4",
      "https://s3plus.meituan.net/mcopilot-pub/nocode-task/chenyanbo/sg1n29zxbn7pthtyjac49ot5e122ys/10.mp4",
      "https://s3plus.meituan.net/mcopilot-pub/nocode-task/chenyanbo/8ck9ueeyci3jmj2qqo0g1e9ro68rv9/11.mp4",
      "https://s3plus.meituan.net/mcopilot-pub/nocode-task/chenyanbo/w456ngo7sr7eb37z2wbkgjkadqoxdi/12.mp4",
      "https://s3plus.meituan.net/mcopilot-pub/nocode-task/chenyanbo/6t9z519ul6ddr6bchu1izzsmrrvqjf/13.mp4",
      "https://s3plus.meituan.net/mcopilot-pub/nocode-task/chenyanbo/6gdwufd7g8u8svmxevdo9afo2p5or2/14.mp4",
      "https://s3plus.meituan.net/mcopilot-pub/nocode-task/chenyanbo/j1vrzhxsxihfjg60yhl19xtpbmhc9h/15.mp4",
    ],
  },
  2: {
    title: "Forbidden Heartbeat",
...
// Ordered list of drama IDs for swipe-to-next-drama (Captive first for EN)
export const DRAMA_ORDER = [5, 2, 1, 3, 4];
...
export const FEATURED_ROLES = [
  ...
  },
  {
    ...
    role: "Campus Heartthrob",
    title: "Forbidden Heartbeat",
    quote: "\"Don't look at me. Watch where you're going.\"",
    episodes: 17,
    hearts: "12.8k",
    tags: ["Campus", "Cold Outside", "Warm Inside"],
    tagCategory: "Dangerous Love",
    image: "https://s3plus.meituan.net/mcopilot-pub/nocode-task/chenyanbo/ujnj6kjw27ro1feytk76v2lr4ztv2r/ep1_60s.jpg",
    isTop: false,
  },
  {
    ...
    role: "Professor",
    title: "Oops, It's Love",
    quote: "\"Seeing you hurt breaks my heart.\"",
    episodes: 5,
    hearts: "6.1k",
    tags: ["Doctor", "Gentle Savior", "Mutual Healing"],
    tagCategory: "Age Gap",
  ...
  },
  {
    ...
    role: "The Ex-Boyfriend",
    title: "My Jerk Ex-Boyfriend",
    quote: "\"Time to settle the score between us.\"",
    episodes: 5,
    hearts: "8.5k",
    tags: ["Ex-BF", "Chase & Regret", "Second Chance"],
    tagCategory: "Chase & Regret",
...
export const TRENDING = [
  {
    ...
    rating: "5.0",
    image: "https://nocode.meituan.com/photo/search?keyword=fantasy,castle,romance&width=400&height=300",
  },
  {
    id: 2,
    title: "Forbidden Heartbeat",
...
export const CHAR_BIO = {
  ...
  "1": "He said 'We're just roommates, nothing more' — then smiled at you. That's when you knew, your heart had no boundaries.",
  "2": "He stood on the balcony smoking, blue haze dissolving into the night. 'You smell nice.' That one line kept you awake all night.",
  "3": "On his first day as a transfer student, he sat beside you. 'We've met before.' He stared into your eyes.",
  "4": "He stood at your door, eyes red. 'I was wrong, but I won't let you go again.'",
};

export const STORY_FEATURES = [
  "Gold-eyed Lion Clan prince, heir to the throne",
  "Dangerous, possessive — but fiercely protective",
  "Your fates are bound by an ancient pact",
];
