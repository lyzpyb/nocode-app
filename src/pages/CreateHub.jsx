...
const MODES = [
  {
    ...
    accentColor: "#60A5FA",
    icon: Wand2,
    image: "https://nocode.meituan.com/photo/search?keyword=film,screenplay,creative&width=400&height=500",
    path: "/comic-demo",
    badge: "漫剧创作",
  },
  {
    ...
    accentColor: "#F472B6",
    icon: Headphones,
    image: "https://nocode.meituan.com/photo/search?keyword=asmr,whisper,intimate,night&width=400&height=500",
    path: "/asmr-create",
    badge: "ASMR 二创",
  },
  {
    ...
    accentColor: "#E8A87C",
    icon: Layers,
    image: "https://nocode.meituan.com/photo/search?keyword=interactive,drama,romance&width=400&height=500",
